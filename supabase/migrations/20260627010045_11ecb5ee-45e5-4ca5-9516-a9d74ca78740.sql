...
BEGIN
  ...
  -- SERVIDOR: usa a MESMA chave de deduplicação do botão do Browser
  -- (compute_djen_conteudo_dedup_key = coordenação + processo + data + conteúdo normalizado sem destinatários).
