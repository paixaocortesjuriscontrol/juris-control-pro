DROP FUNCTION IF EXISTS public.get_processos_paginados(integer, integer, text, text, text, uuid, uuid, text, boolean, boolean, boolean, boolean, boolean, timestamptz, timestamptz, uuid[], text, text, boolean, boolean);

CREATE OR REPLACE FUNCTION public.get_processos_paginados(
  _page integer DEFAULT 1, _page_size integer DEFAULT 50, _search text DEFAULT NULL,
  _area text DEFAULT NULL, _status text DEFAULT NULL, _coordenacao_id uuid DEFAULT NULL,
  _responsavel_id uuid DEFAULT NULL, _instancia text DEFAULT NULL,
  _com_movimento boolean DEFAULT false, _com_publicacao_djen boolean DEFAULT false,
  _com_audiencia boolean DEFAULT false, _com_intimacao boolean DEFAULT false,
  _com_tarefa boolean DEFAULT false, _periodo_inicio timestamptz DEFAULT NULL,
  _periodo_fim timestamptz DEFAULT NULL, _cliente_ids uuid[] DEFAULT NULL,
  _tipo_processo text DEFAULT NULL, _testemunha_nome text DEFAULT NULL,
  _com_testemunha boolean DEFAULT false, _acompanhamento_especial boolean DEFAULT false,
  _segredo_justica boolean DEFAULT false)
