...
DECLARE
  ...
  v_source_ids uuid[];
BEGIN
  SELECT id INTO v_target_id FROM public.clientes WHERE nome = 'Salute Clínicas Médicas Especializadas' LIMIT 1;
  ...
  WHERE nome = 'Salute Clínicas Médicas Especializadas Ltda - Matriz' AND id != v_target_id;
