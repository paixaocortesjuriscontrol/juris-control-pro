WITH publicacoes_hoje AS (
  ...
  WHERE fonte = 'kurier'
    AND created_at >= timezone('America/Sao_Paulo', current_date::timestamp)
  ...
  SET publicacao_djen_id = NULL,
      motivo_descarte = COALESCE(motivo_descarte, 'publicacao_kurier_hoje_removida_por_data_disp')
