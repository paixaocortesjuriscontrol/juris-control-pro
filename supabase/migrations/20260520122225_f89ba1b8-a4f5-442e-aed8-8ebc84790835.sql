...
REVOKE ALL ON FUNCTION public.apply_data_planilha_fix(jsonb) FROM PUBLIC, authenticated, anon;
GRANT EXECUTE ON FUNCTION public.apply_data_planilha_fix(jsonb) TO service_role;