...
SELECT p.id, origem.t, '8bf8b0a9-bdbd-4be9-82a7-2109261e02c2'::uuid, 'Katarine Dias', now()
FROM public.publicacoes_djen p
CROSS JOIN (VALUES ('processo'), ('descartada')) AS origem(t)
