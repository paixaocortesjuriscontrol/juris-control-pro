-- RPC para contagem deduplicada de publicações DJEN NÃO LIDAS (hoje)
CREATE OR REPLACE FUNCTION public.count_djen_publicacoes_deduplicadas_hoje_nao_lidas()
...
-- RPC para contagem deduplicada de publicações DJEN NÃO LIDAS por coordenação (hoje)
CREATE OR REPLACE FUNCTION public.count_djen_publicacoes_deduplicadas_hoje_por_coordenacao_nao_lidas(
