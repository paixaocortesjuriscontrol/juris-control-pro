...
tar AS (
 SELECT b.*,CASE WHEN b.origem IN ('astrea','projuris','importacao','import','planilha','migracao','carga','benner') THEN a.data_original ELSE b.data_cumprimento END data_conclusao_filtro
