...
tar_resp AS (
 SELECT r.usuario_id uid,t.*,
  -- Pontualidade só é mensurável quando existe prazo independente da conclusão.
  -- Em cargas importadas sem data fatal/prevista, a data do compromisso muitas vezes
  -- é a própria data de conclusão: nesse caso não há base de comparação.
