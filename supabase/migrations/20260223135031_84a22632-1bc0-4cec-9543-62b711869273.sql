-- Atualizar a RPC para retornar campos estruturados de publicacoes_djen_processos
-- (antes retornava NULL::text para orgao, tipo_comunicacao, meio, advogados_json, partes_json)
