...
-- Recriar a RPC com suporte a p_monitoramento_id
-- Quando fornecido, a dedup prioriza publicações desse monitoramento
  ...
  WITH
    base AS (
      SELECT
        ...
        -- Prioridade: se p_monitoramento_id fornecido, publicações desse termo vêm primeiro
...
-- Também atualizar a count RPC para aceitar o mesmo parâmetro (consistência)
