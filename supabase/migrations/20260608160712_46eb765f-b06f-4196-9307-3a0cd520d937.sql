...
BEGIN
  ...
  -- TERMOS: usa a MESMA chave do card "Publicações Únicas"
  -- (compute_djen_conteudo_dedup_key), garantindo que após o descarte
  -- "todas" e "únicas" fiquem iguais.
  ...
  -- PROCESSOS: mesma lógica com a mesma chave
