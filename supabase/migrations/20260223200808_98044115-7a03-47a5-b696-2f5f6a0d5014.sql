...
-- Fix: use actual tribunal from publicacoes_djen instead of NULL
...
RETURNS TABLE(
  id uuid, tipo_origem text, processo_id uuid, processo_numero text,
  conteudo text, data_publicacao text, data_disponibilizacao text,
  fonte text, lida boolean, created_at timestamptz,
  ...
  polo_ativo text, polo_passivo text, tribunal text,
  orgao text, tipo_comunicacao text, meio text,
  advogados_json jsonb, partes_json jsonb
)
