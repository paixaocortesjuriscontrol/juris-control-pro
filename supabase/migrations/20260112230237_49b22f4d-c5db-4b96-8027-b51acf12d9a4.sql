...
DECLARE
  ...
  v_source_ids uuid[];
BEGIN
  SELECT id INTO v_target_id FROM public.clientes WHERE nome = 'Centro Radiológico de Brasília S/A' LIMIT 1;
  ...
  WHERE nome = 'Centro Radiológico de Brasília S/A, Radiotec Serviços Técnicos em Radiologia LTDA' AND id != v_target_id;
