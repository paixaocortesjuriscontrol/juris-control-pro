          ...
          properties: {
            distribuicao_tst: {
              ...
              properties: {
                ...
                aparelhamento_reclamante: { type: "string", enum: ["BEM_APARELHADO", "MAL_APARELHADO"] },
                aparelhamento_banco: { type: "string", enum: ["BEM_APARELHADO", "MAL_APARELHADO"] },
                chance_exito_reclamante: { type: "string", enum: ["ALTA", "MEDIA", "BAIXA"] },
                chance_exito_banco: { type: "string", enum: ["ALTA", "MEDIA", "BAIXA"] },
                honra: { type: "string" },
                tema: { type: "string" },
