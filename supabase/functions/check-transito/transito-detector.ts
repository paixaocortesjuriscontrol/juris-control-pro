...
const CODIGOS_ADMIN = new Set([
  3, 4, 11, 12, 14, 22, 26, 36, 50, 51, 60, 61, 67, 85, 92, 123, 132,
  192, 193, 194, 236, 246, 268, 581, 848, 852, 981, 1037, 1061,
  10001, 10003, 10004, 10005, 10006, 10044, 10045, 10966, 11009, 11010, 12265,
]);
