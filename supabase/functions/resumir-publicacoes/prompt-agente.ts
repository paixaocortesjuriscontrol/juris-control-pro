// Auto-generated from prompt-agente.md
export const SYSTEM_PROMPT = `# AGENTE DE RESUMO DE PUBLICAÇÕES — DJEN / PJe (v5)
...
### 5.2. Formato alternativo: texto plano
Use apenas se o usuário solicitar expressamente. Estrutura (sem negrito, sem bullets, sem markdown):
