  ...
  try {
    ...
    if (completeRun) {
      ...
      while (true) {
        ...
        totalResults.redistributions += results.redistributions;
      ...
      return new Response(
        JSON.stringify({
          success: true,
          message: `Monitoramento completo: ${totalResults.checked} processos verificados, ${totalResults.redistributions} redistribuições`,
