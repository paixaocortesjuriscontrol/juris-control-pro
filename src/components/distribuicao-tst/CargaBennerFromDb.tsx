  ...
  const processData = async () => {
    ...
    try {
      ...
      for (let i = 0; i < allDist.length; i++) {
        ...
        // "Outra Matéria" é considerada válida (consta na lista oficial), mas o
        // nome NUNCA aparece na planilha: a linha vai com a matéria em branco.
