...
const secretsInfo = [
  ...
  },
  {
    ...
    description: "Chave anônima (pública) do Supabase para operações de cliente com RLS.",
    value: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...",
    category: "Supabase",
  },
  {
    name: "SUPABASE_PUBLISHABLE_KEY",
    description: "Chave publicável do Supabase, idêntica à ANON_KEY. Utilizada no frontend.",
    value: "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...",
    category: "Supabase",
  },
  {
    name: "SUPABASE_SERVICE_ROLE_KEY",
    description: "Chave de serviço do Supabase com bypass de RLS. Usada exclusivamente em Edge Functions para operações administrativas.",
    value: "****** (armazenada de forma segura)",
    category: "Supabase",
  },
  {
    name: "SUPABASE_DB_URL",
    description: "URL de conexão direta ao banco PostgreSQL do Supabase.",
    value: "postgresql://postgres:***@db.bfxahrrvoqxcdmfsvnrk.supabase.co:5432/postgres",
    category: "Supabase",
  },
  {
    name: "RESEND_API_KEY",
    description: "Chave de API do Resend para envio de emails transacionais (notificações, alertas, lembretes).",
    value: "re_****** (armazenada de forma segura)",
    category: "Email",
  },
  {
    name: "OPENAI_API_KEY",
    description: "Chave de API da OpenAI para funcionalidades de IA: resumos de publicações, análise de documentos e assistente jurídico.",
    value: "sk-****** (armazenada de forma segura)",
    category: "Inteligência Artificial",
  },
  {
    name: "JINA_API_KEY",
    description: "Chave de API do Jina AI para extração de conteúdo de páginas web (web scraping) no monitoramento DJEN.",
    value: "jina_****** (armazenada de forma segura)",
    category: "Inteligência Artificial",
  },
  {
    name: "ZAPI_INSTANCE_ID",
    description: "ID da instância Z-API para integração com WhatsApp. Identifica a conexão específica.",
    value: "****** (armazenada de forma segura)",
    category: "WhatsApp",
  },
  {
    name: "ZAPI_TOKEN",
    description: "Token de autenticação da Z-API para envio de mensagens WhatsApp.",
    value: "****** (armazenada de forma segura)",
    category: "WhatsApp",
  },
  {
    name: "ZAPI_CLIENT_TOKEN",
    description: "Token do cliente Z-API obrigatório para webhooks e callbacks. Usado nas Edge Functions para autenticação.",
    value: "****** (armazenada de forma segura)",
    category: "WhatsApp",
  },
  {
    name: "LOVABLE_API_KEY",
    description: "Chave de API do Lovable para integrações e funcionalidades da plataforma de desenvolvimento.",
    value: "****** (armazenada de forma segura)",
    category: "Plataforma",
  },
];
