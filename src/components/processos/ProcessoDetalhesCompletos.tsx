...
export function ProcessoDetalhesCompletos({
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="flex">
        {/* Sidebar Navigation */}
        <aside className="w-32 sm:w-40 md:w-48 border-r bg-muted/20 flex-shrink-0">
          <nav className="py-2">
            {navItems.map((item) => (
              <button
                key={item.id}
                ...
                className={cn(
                  "w-full flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-2 text-xs sm:text-sm text-left transition-colors",
              ...
              >
                ...
                {item.count !== undefined && item.count > 0 && (
                  <Badge variant="secondary" className="ml-auto text-[9px] sm:text-[10px] h-4 sm:h-5 px-1">
                    {item.count}
                  </Badge>
                )}
              </button>
          ...
          <ScrollArea className="h-[calc(100vh-120px)]">
            <div className="p-3 sm:p-4">
                  ...
                  {tarefas.length > 0 ? (
                    <div className="space-y-2">
                      {tarefas.map((tarefa: any) => (
                        <div key={tarefa.id} className="flex items-center justify-between py-2 px-3 border rounded-lg">
                          <div>
                          ...
                          <Badge variant={tarefa.status === "concluida" ? "secondary" : "default"} className="text-xs">
                            {tarefa.status}
                          </Badge>
                        </div>
                      ))}
              ...
              {activeSection === "andamentos" && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="font-semibold text-sm">Andamentos</h3>
              ...
              {activeSection === "envolvidos" && (
                <div className="space-y-3">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="font-semibold text-sm">Envolvidos</h3>
                    <Button size="sm" className="bg-emerald-600 hover:bg-emerald-700 text-xs h-7">
                      Adicionar
                    </Button>
                  </div>
              ...
              {activeSection === "financeiro" && (
                <div className="space-y-3">
                  <h3 className="font-semibold text-sm mb-3">Financeiro</h3>
              ...
              {activeSection === "comentarios" && (
                <div className="space-y-3">
                  <h3 className="font-semibold text-sm mb-3">Comentários</h3>
                  <div className="space-y-3">
