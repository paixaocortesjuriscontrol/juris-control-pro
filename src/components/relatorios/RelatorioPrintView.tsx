...
export const RelatorioPrintView = forwardRef<HTMLDivElement, RelatorioPrintViewProps>(
  ({ resumoData, atividadesData, clientesData, mode = "completo" }, ref) => {
                ...
                <div className="grid grid-cols-4 gap-4 mb-8">
                  ...
                  <div className="border border-gray-300 rounded-lg p-4 text-center">
                    <p className="text-3xl font-bold text-amber-600">
                      {clientesData.processosPorCliente?.reduce(
                        (acc: number, c: any) => acc + c.prazosPendentes,
                        0
                      ) || 0}
                    </p>
                      ...
                      <tbody>
                        {clientesData.processosPorCliente.map((cliente: any) => (
                          <tr key={cliente.nome}>
                            ...
                            <td className="border border-gray-300 px-3 py-2 text-right text-amber-600">
                              {cliente.prazosPendentes}
                            </td>
                          </tr>
                        ))}
                      </tbody>
