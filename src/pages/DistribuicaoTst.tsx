...
export default function DistribuicaoTst() {
  ...
  const hasFilters = filtroProcesso || filtroDossie || filtroTurma || filtroRelator || filtroParte || filtroNomeParte || filtroDataInicio || filtroDataFim || filtroAba !== "todas" || filtroBenner !== "todos" || filtroMesAno !== "todos" || filtroDossieStatus !== "todos" || filtroProcessoStatus !== "todos" || filtroJudit !== "todos" || filtroErroJudit !== "todos" || filtroSituacaoProcesso !== "todos" || filtroStatus !== "todos" || filtroEmAnalise !== "todos" || filtroDuplicado !== "todos" || filtroFonteImportacao !== "todas" || filtroProvasDigitais !== "todos" || filtroSituacaoCarga !== "todas" || filtroEquipe !== "todos";
        ...
        <div className="border border-border rounded-lg p-4 space-y-3 bg-muted/30">
          ...
          <div className="space-y-2 pt-2 border-t border-border/50">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-2">
              ...
              <div className="space-y-0.5">
                <Label className="text-[10px] text-muted-foreground">Benner</Label>
              ...
              <div className="space-y-0.5">
                <Label className="text-[10px] text-muted-foreground">Dossiê</Label>
              ...
              <div className="space-y-0.5">
                <Label className="text-[10px] text-muted-foreground">Judit</Label>
              ...
              <div className="space-y-0.5">
                <Label className="text-[10px] text-muted-foreground">Duplicados</Label>
              ...
              <div className="space-y-0.5">
                <Label className="text-[10px] text-muted-foreground">Origem importação</Label>
              ...
              <div className="space-y-0.5">
                <Label className="text-[10px] text-muted-foreground">Status envio</Label>
                <Select
              ...
              <div className="space-y-0.5">
                <Label className="text-[10px] text-muted-foreground">Em análise</Label>
