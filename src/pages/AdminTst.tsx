...
const groups: { title: string; description: string; tools: Tool[] }[] = [
  {
    ...
    tools: [
      { label: "Importar PDF Certidão", path: "/admin-tst/importar-certidao-pdf", icon: FileSignature, description: "Cadastra novos processos a partir do PDF da Certidão de Distribuição do TST. Processos existentes na base de dados terão a data de distribuição atualizada de acordo com a informada na certidão." },
