...
export default function ImportarCertidaoPdf() {
  return (
    <PaginaImportacao
      ...
      descricao="Cadastra novos processos a partir do PDF da Certidão de Distribuição do TST. Processos que já existem na base de dados não são alterados de forma alguma."
      comoUsar={[
        ...
        "Processos que já existem na base não são alterados (nem a data de distribuição): eles apenas aparecem no relatório — pode importar o mesmo arquivo novamente com segurança.",
        "Se houver rejeitados ou duplicados, um relatório em Excel é baixado automaticamente no fim da importação (abas Resumo, Rejeitados e Duplicados).",
      ]}
